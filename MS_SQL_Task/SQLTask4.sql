...
--Question 1: Display name and commission of all the salesmen
select name,comission from salesman

--Question 2: Retrieve salesman id of all salesmen from orders table without any repeats.
select salesman_id from customer 

--Question 3: Display names and city of salesman, who belongs to the city of Paris.
select name,city from salesman where city = 'Paris'

--Question 4: Display all the information for those customers with a grade of 200.
select * from customer where grade = '200'

--Question 5: Display the order number, order date and the purchase amount form order(s) 
...
--Question 6: Show the winner of the 1971 prize for Literature.select winner from nobel_win where year='1971' and subject='Literature'

--Question 7: Show all the details of the winners with first name Louis. 
select * from nobel_win where winner like 'Louis %'

--Question 8: Show all the winners in Physics for 1970 together with the winner of Economics 
--for 1971.
select * from nobel_win where (subject='Phyics' and year='1970') or (subject = 'Economics' and year = '1971')

--Question 9:Show all the winners of Nobel prize in the year 1970 except the subject 
--Physiology and Economics.select * from nobel_win where year = '1970' and (subject != 'Physiology' and subject != 'Economics')

--Question 10: Find all the details of the Nobel winners for the subject not started with the 
--letter 'P' and arranged the list as the most recent comes first, then by name in order.
select * from nobel_win where subject not like 'P%' order by winner desc
